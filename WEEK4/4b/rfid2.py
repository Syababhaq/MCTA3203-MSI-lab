...
RFID_PORT = "COM10"   # Update with the correct RFID COM port
ARDUINO_PORT = "COM7"  # Update with the correct Arduino COM port
BAUD_RATE_RFID = 9600  # RFID reader baud rate
BAUD_RATE_ARDUINO = 9600  # Arduino baud rate
